                ...
                <div className="rounded-t-[15vw] bg-gray-50 w-full h-max p-[8vw]">
                    <div className="flex justify-around">
                        ...
                        <div className="flex flex-col justify-center w-[70%] h-max px-4">
                            <p className="text-[1.2rem] md:text-[20px] text-[#262626] font-medium">2 недели</p>
                    ...
                    <div className="flex justify-around mt-12">
                        ...
                        <div className="flex flex-col justify-center w-[70%] h-max px-4">
                            <p className="text-[1.2rem] md:text-[20px] text-[#262626] font-medium">Не важно</p>
                    ...
                    <div className="flex justify-around mt-12">
                        ...
                        <div className="flex flex-col justify-center w-[70%] h-max px-4">
                            <p className="text-[1.2rem] md:text-[20px] text-[#262626] font-medium">Рассрочка</p>
                            <p className="text-[0.8rem] md:text-[15px] text-[#262626]/70 font-medium">до 24 месяцев</p>
