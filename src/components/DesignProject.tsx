    ...
    return (
        <section id="planning" className="p-10 relative -top-25">
            ...
            <p className="my-4 font-normal text-[#262626B2]">
                Разработаем планировочное решение вашей квартиры. На основе созданного планировочного решения мы
                подготовим альбом, состоящий из 9 чертежей, необходимых строителям для ремонта.
            </p>
