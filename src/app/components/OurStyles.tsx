...
import { PiCaretLeft, PiCaretRight, PiHandbag } from "react-icons/pi";
                        ...
                        <div key={item.id} className="min-w-full shrink">
                            <div className="relative">
                                <Image
                                    ...
                                    height={1}
                                    sizes="100vw"
                                    className="w-full h-60 object-cover object-center rounded-[20px]"
                                    loading="lazy"
                                />
                            ...
                            <div className="flex justify-between items-center p-4">
                                ...
                                <button className="flex items-center justify-center bg-gray-100 w-37.5 h-14 rounded-full gap-2">
                                    ...
                                    <span className="text-[#BD7048] text-[1rem] font-semibold">
                                        Выбрать
                                    </span>
                                </button>
                            </div>
